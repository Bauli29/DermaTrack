...
class StatisticsControllerIntegrationTest {
        ...
        void getPsycheAndSymptoms_ShouldReturnLineChart() throws Exception {
                ...
                mockMvc.perform(get("/api/statistics/psyche-symptoms")
                                .with(user("statsuser"))
                                .queryParam("startDate", "2026-04-20")
        ...
        void getSymptoms_WithCustomDateRange_ShouldReturnCorrectWindow() throws Exception {
                diaryEntryRepository.save(buildEntry(
                                testUser,
        ...
        @Test
        @DisplayName("GET /api/statistics/psyche-symptoms with invalid startDate should return 400")
        void getPsycheAndSymptoms_WithInvalidStartDate_ShouldReturn400() throws Exception {
                mockMvc.perform(get("/api/statistics/psyche-symptoms")
                                .with(user("statsuser"))
